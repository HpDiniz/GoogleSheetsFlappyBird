(() => {
    ...
    function gameLoop() {
        ...
        if (gameStarted) {
            ...
            if (checkCollision()) {
                ...
                setTimeout(() => {
                    showRestartButton("Você colidiu com um obstáculo!");
                }, 500);
                return;
            }
    ...
    function showRestartButton(reason) {
        // Limpar conteúdo anterior usando textContent
        countdownText.textContent = "";

        // Remover filhos anteriores (se houver)
    ...
    console.log("✅ Flappy Bird v6 iniciado!");
